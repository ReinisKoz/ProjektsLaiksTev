...
<body>
    ...
    <main>
        <section>
            ...
            <img src="/Images/Fitness.webp" alt="Fitness image">
...
h1, h2 {
    text-align: center;
    color: #3d3d3d; /* Dark gray for contrast */
}
...
.service-button {
    background-color: #f8c5c5; /* Soft pastel pink */
    color: #3d3d3d;
    padding: 12px 20px;
...
.service-button:hover {
    background-color: #f4b4b4; /* Slightly darker pink on hover */
